...
in {
  ...
  azure-cosmosdb-table = callPackage ../development/python-modules/azure/cosmosdb-table.nix { };
  azure-cosmosdb-nspkg = callPackage ../development/python-modules/azure/cosmosdb-nspkg.nix { };
  azure-nspkg = callPackage ../development/python-modules/azure/nspkg.nix { };
  azure-common = callPackage ../development/python-modules/azure/common.nix { };
  azure-storage = callPackage ../development/python-modules/azure/storage.nix { };
  azure-storage-common = callPackage ../development/python-modules/azure/storage-common.nix { };
  azure-storage-nspkg = callPackage ../development/python-modules/azure/storage-nspkg.nix { };
